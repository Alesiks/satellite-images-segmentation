...
class Tiramisu(object):
    ...
    def getTiramisu(self):
        ...
        self.__get_dense_block(5, 108)
        self.__get_transition_down(108)
        # self.__get_dense_block(5, 168)
        ...
        self.__get_dense_block(15, 108)

        # self.__get_transition_up(468, (468, 7, 7), (None, 468, 14, 14))
        # self.__get_dense_block(5, 468)

        # self.__get_transition_up(348, (348, 14, 14), (None, 348, 28, 28))
        # self.__get_dense_block(5, 348)
        #
        # self.__get_transition_up(288, (288, 28, 28), (None, 288, 56, 56))
        # self.__get_dense_block(5, 348)

        # self.__get_transition_up(168, (168, 56, 56), (None, 168, 112, 112))
        # self.__get_dense_block(5, 288)

        self.__get_transition_up(108, (108, 112, 112), (None, 108, 224, 224))
        self.__get_dense_block(5, 228)
